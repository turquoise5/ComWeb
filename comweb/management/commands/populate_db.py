...
from comweb.management.commands.utils.inclusion_populator import populate_auto_inclusions, populate_methods
...
from comweb.management.commands.data import types_data, modes_data, problem_type_data, bounds_data, method_data
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        populate_classes(problem_type_data, bounds_data, machines)
        populate_mmg()
        populate_mtg()
        populate_methods(method_data)
        populate_auto_inclusions()                    
